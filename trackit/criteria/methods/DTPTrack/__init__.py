        ...
        for i, output in enumerate(outputs):
            ...
            if has_positive_samples:
                ...
                try:
                    ...
                    raise IndexError(
                        f'IndexError: positive_sample_batch_dim_index.shape={positive_sample_batch_dim_index.shape}, '
                        f'positive_sample_feature_map_dim_index.shape={positive_sample_feature_map_dim_index.shape}, '
                        f'predicted_bboxes.shape={predicted_bboxes.shape}, '
                        f'num_positive_samples={num_positive_samples}') from e
