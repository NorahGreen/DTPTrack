# https://github.com/VICO-UoE/URL/blob/master/models/losses.py
...
def knn_loss(support_embeddings, support_labels,
    ...
    logits = torch.zeros(embeds.size(0), n_way).to(embeds.device).scatter_(1,
                                                                           support_labels[inds.flatten()].view(-1, 1),
                                                                           1) * 10
