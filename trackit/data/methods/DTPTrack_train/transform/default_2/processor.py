...
class SPMTrackDataProcessor(SPMTrackTrain_DataTransform):
    def __init__(self,
                 ...
                 search_region_siamfc_cropping_parameters: SiamFCCroppingParameter | Sequence[SiamFCCroppingParameter],
        ...
        self.search_region_siamfc_cropping = SiamFCCropping(search_region_siamfc_cropping_parameters) if isinstance(search_region_siamfc_cropping_parameters, SiamFCCroppingParameter) else \
            tuple(SiamFCCropping(param) for param in search_region_siamfc_cropping_parameters)
    ...
    def __call__(self, training_pair: SiameseTrainingMultiPair, rng_engine: np.random.Generator):
        ...
        if isinstance(self.search_region_siamfc_cropping, SiamFCCropping):
            search_region_siamfc_cropping = [self.search_region_siamfc_cropping for _ in range(len(training_pair.search))]
        else:
            search_region_siamfc_cropping = self.search_region_siamfc_cropping
        ...
        for i in range(len(training_pair.search)):
            if not search_region_siamfc_cropping[i].prepare(f'x_{i}', rng_engine, context):
                return None
