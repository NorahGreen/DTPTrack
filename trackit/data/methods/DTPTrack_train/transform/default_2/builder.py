...
def _build_sub_siamfc_cropping_parameter(siamfc_cropping_config: dict, output_size: Tuple[int, int],
...
def _build_siamfc_cropping_parameter(siamfc_cropping_config: list | dict,
                                     output_size: Tuple[int, int],
                                     interpolation_mode: str,
                                     interpolation_align_corners: bool) -> SiamFCCroppingParameter | Sequence[
    SiamFCCroppingParameter]:
    return tuple(_build_sub_siamfc_cropping_parameter(
        siamfc_cropping_config[i] if isinstance(siamfc_cropping_config, list) else siamfc_cropping_config,
        output_size, interpolation_mode, interpolation_align_corners) for i in range(len(siamfc_cropping_config)))
