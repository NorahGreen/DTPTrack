...
from ....siamese._algos import _get_search_frame_candidates, SiamesePairSamplingMethod
...
class IncreasedDifficultyAuxFrameSampling(TemporalTrainingSampleAdaptor):
    ...
    def __call__(self, siamese_training_pair: SiameseTrainingPairSamplingResult, rng_engine: np.random.Generator):
        ...
        if siamese_training_pair.aux_frames is not None:
            search_regions.extend(siamese_training_pair.aux_frames)
