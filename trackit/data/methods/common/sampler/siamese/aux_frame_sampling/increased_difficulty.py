...
class IncreasedDifficultyAuxFrameSampling(AuxFrameSampling):
    ...
    def __call__(self, siamese_training_pair: SiameseTrainingPairSamplingResult, rng_engine: np.random.Generator):
        if siamese_training_pair.is_positive:
            ...
            return SiameseTrainingPairSamplingResult(SamplingResult_Element(z.dataset_index, z.sequence_index, z.track_id, aux_frame_index),
                                                     siamese_training_pair.z,
