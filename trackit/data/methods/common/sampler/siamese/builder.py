...
def build_SiamFC_training_pair_sampler(datasets: Sequence[TrackingDataset], datasets_sampling_weight: np.ndarray,
    ...
    tweak_template_frame_got10k_absense_cover_level = None
    tweak_search_region_frame_got10k_absense_cover_level = None
    if 'tweak' in siamese_sampling_config:
        tweak_template_frame_got10k_absense_cover_level = siamese_sampling_config['tweak'].get('template_selection_got10k_absense_cover_level', None)
        tweak_search_region_frame_got10k_absense_cover_level = siamese_sampling_config['tweak'].get('search_region_selection_got10k_absense_cover_level', None)
    ...
    return SiamFCTrainingPairSampler(datasets, datasets_sampling_weight, sequence_picker,
                                     ...
                                     tweak_template_frame_got10k_absense_cover_level=tweak_template_frame_got10k_absense_cover_level,
                                     tweak_search_region_frame_got10k_absense_cover_level=tweak_search_region_frame_got10k_absense_cover_level)
