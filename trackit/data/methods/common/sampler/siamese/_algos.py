...
def get_random_positive_siamese_training_pair_from_track(
        track: TrackingDataset_Track, extra_template_frame_selection_mask: Optional[np.ndarray],
    ...
    return _do_siamfc_pair_sampling(len(track), frame_range, track.get_all_object_existence_flag(),
                                    extra_template_frame_selection_mask,
                                    sampling_method,
                                    rng_engine, frame_range_auto_extend_step, frame_range_auto_extend_max_retry_count,
                                    ignore_frame_range_if_no_candidates_found)
