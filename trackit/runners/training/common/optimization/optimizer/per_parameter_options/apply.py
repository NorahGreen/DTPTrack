...
def _apply_per_parameter_adjustment_rules_(base_lr: float, base_weight_decay: Optional[float], per_parameter_rules: dict,
    ...
    for per_parameter_rule in per_parameter_rules:
        ...
        elif per_parameter_rule['type'] == 'siamese_fusion_vit_lr_layer_decay':
            from .vit_lr_layer_decay import apply_siamese_fusion_vit_lr_layer_decay_
            apply_siamese_fusion_vit_lr_layer_decay_(per_parameter_rule, base_lr, base_weight_decay, remaining_module_parameters, optimizer_param_dict, decay_parameter_names)
        ...
        elif per_parameter_rule['type'] == 'muon':
            from .muon import apply_muon_rule_
            apply_muon_rule_(per_parameter_rule, remaining_module_parameters, optimizer_param_dict, decay_parameter_names)
        else:
