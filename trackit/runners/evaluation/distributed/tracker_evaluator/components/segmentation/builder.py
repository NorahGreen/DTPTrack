...
from .video_wrapper import Segmentify_VideoSegmentationModel_PostProcessor
...
def build_segmentify_post_processor_video_based(segmentify_post_processor_config: dict,
                                                common_config: dict,
                                                device: torch.device) -> Segmentify_VideoSegmentationModel_PostProcessor:
    return Segmentify_VideoSegmentationModel_PostProcessor(segmentify_post_processor_config['model_name'],
                                                           segmentify_post_processor_config['search_region_size'],
                                                           segmentify_post_processor_config['area_factor'],
                                                           common_config['interpolation_mode'],
                                                           device)
