...
class CheckpointStatefulObjectRegistry:
    ...
    class _Parameters:
        ...
        set_state_fn: Callable[[Any], Any]
        main_process_only: bool

    def __init__(self):
        self.objects = {}

    def register(self, name: str, get_state_fn: Callable[[], Any], set_state_fn: Callable[[Any], Any], main_process_only=False, priority: int = 50) -> None:
