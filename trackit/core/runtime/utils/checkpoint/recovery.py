...
def has_recovery_file(checkpoint_path: str) -> bool:
    """
    Check if the recovery file exists in the given checkpoint path.

    Args:
        checkpoint_path (str): The path to the checkpoint file.

    Returns:
        bool: True if the recovery file exists, False otherwise.
    """
...
def get_recovery_file_path(checkpoint_path: str) -> str:
    """
    Get the path to the recovery file based on the checkpoint path.

    Args:
        checkpoint_path (str): The path to the checkpoint file.

    Returns:
        str: The path to the recovery file.
    """
