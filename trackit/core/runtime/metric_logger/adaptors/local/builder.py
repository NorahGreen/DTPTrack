...
def construct_local_metric_logger(logger_dispatcher: MetricLogger, logging_config: Optional[dict], build_context: BuildContext):
    ...
    build_context.services.event.register_on_epoch_begin_event_listener(metric_logger.on_epoch_begin)
    build_context.services.event.register_on_epoch_end_event_listener(metric_logger.on_epoch_end)
